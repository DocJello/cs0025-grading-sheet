        ...
        reader.onload = async (e) => {
            try {
                ...
                for (const [index, row] of json.entries()) {
                    ...
                    const name = typedRow[nameKey];
                    const email = typedRow[emailKey];
                    const roleStr = typedRow[roleKey];
                    ...
                    if (existingEmails.has(String(email).toLowerCase())) {
                    ...
                    existingEmails.add(String(email).toLowerCase()); // Prevent duplicates within the same file
                    addedCount++;
                }
