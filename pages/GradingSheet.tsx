...
interface GradingSheetProps {
    // No props needed as state is now managed in context
}
...
const GradingSheet: React.FC<GradingSheetProps> = () => {
    const { gradeSheets, updateGradeSheet, currentUser, venues, addVenue, selectedGradeSheetId, setCurrentPage } = useAppContext();
    
    const gradeSheetId = selectedGradeSheetId;
