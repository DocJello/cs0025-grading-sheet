...
import { User, UserRole, GradeSheet, GradeSheetStatus, Page } from '../types';
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const login = async (email: string, pass: string): Promise<string> => {
        try {
            ...
            setCurrentUser(user);
            setCurrentPage('dashboard'); // On successful login, go to dashboard
    ...
    const value = {
        ...
        isLoading,
        currentPage,
        selectedGradeSheetId,
        setCurrentPage,
        navigateToGradeSheet,
        login,
        logout,
        findUserById,
        getPanelSheets,
