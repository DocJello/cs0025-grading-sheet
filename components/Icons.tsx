...
export const WrenchScrewdriverIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.87-5.87m0 0L11.42 15.17m5.87-5.87L11.42 15.17m0 0L5.75 21A2.652 2.652 0 0 1 2 17.25l5.87-5.87m0 0L2 5.75A2.652 2.652 0 0 1 5.75 2l5.87 5.87m0 0L17.25 2A2.652 2.652 0 0 1 21 5.75l-5.87 5.87m0 0L11.42 15.17" />
    </svg>
);
